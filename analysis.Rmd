...
```
```{r}
oligo::boxplot(raw_data, main = "Boxplot of log2-intensitites for the raw data", ldw = 2)
```
...
```{r}
exp_norm <- log2(Biobase::exprs(norm_data))
...
```{r}
topTable(fit, coef = "Normal - ESCC", adjust = "BH")
